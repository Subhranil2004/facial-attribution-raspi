...
emotion_interpreter = tf.lite.Interpreter(model_path="emotion_detection_model_100epochs_opt.tflite")
emotion_interpreter.allocate_tensors()

age_interpreter = tf.lite.Interpreter(model_path="age_detection_model_50epochs_opt.tflite")
age_interpreter.allocate_tensors()

gender_interpreter = tf.lite.Interpreter(model_path="gender_detection_model_50epochs_opt.tflite")
