...
string_pred_age = ['04-06 yrs', '07-08 yrs','09-11 yrs','12-19 yrs','20-27 yrs','28-35 yrs','36-45 yrs','46-60 yrs','61-75 yrs']
...
class UI_CameraWindow(QWidget):
    ...
    def retranslateUI(self):
        ...
        self.setWindowTitle(_translate(
            "App", "Gender and Age Classification: Live Webcam"))
        self.setStyleSheet("background-color: black;")
    ...
    def Webcam_update(self):
        ...
        for x, y, w, h in faces:
            ...
            if input_im is not None:
                ...
                predicted_age = string_pred_age[index_pred_age]
                predicted_gender = string_pred_gen[index_pred_gender]

                font = cv2.FONT_HERSHEY_PLAIN
                cv2.putText(frame, predicted_gender + ", " + predicted_age , (x,y), font, 1.5, (0,255, 0), 1, cv2.LINE_AA)
